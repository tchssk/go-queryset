...
// nolint: dupl
func (qs UserQuerySet) PasswordEq(password []byte) UserQuerySet {
	return qs.w(qs.db.Where("password = ?", password))
}

// PasswordIn is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) PasswordIn(password ...[]byte) UserQuerySet {
	if len(password) == 0 {
...
// nolint: dupl
func (qs UserQuerySet) PasswordNe(password []byte) UserQuerySet {
	return qs.w(qs.db.Where("password != ?", password))
}

// PasswordNotIn is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) PasswordNotIn(password ...[]byte) UserQuerySet {
	if len(password) == 0 {
...
// PreloadPosts is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) PreloadPosts() UserQuerySet {
	return qs.w(qs.db.Preload("Posts"))
}
...
// nolint: dupl
func (u UserUpdater) SetPassword(password []byte) UserUpdater {
